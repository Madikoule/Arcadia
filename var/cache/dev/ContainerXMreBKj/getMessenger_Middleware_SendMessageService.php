...
class getMessenger_Middleware_SendMessageService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a = ($container->privates['.service_locator.g3JxlbG'] ?? $container->load('get_ServiceLocator_G3JxlbGService'));
        ...
        $container->privates['messenger.middleware.send_message'] = $instance = new \Symfony\Component\Messenger\Middleware\SendMessageMiddleware(new \Symfony\Component\Messenger\Transport\Sender\SendersLocator(['Symfony\\Component\\Mailer\\Messenger\\SendEmailMessage' => [0 => 'sync'], 'Symfony\\Component\\Notifier\\Message\\ChatMessage' => [0 => 'sync'], 'Symfony\\Component\\Notifier\\Message\\SmsMessage' => [0 => 'sync'], 'App\\Message\\YourMessage' => [0 => 'amqp']], $a), $b);
