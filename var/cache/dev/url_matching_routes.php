...
return [
    ...
    [ // $staticRoutes
        ...
        '/connexion' => [[['_route' => 'connexion_connexions', '_controller' => 'App\\Controller\\ConnecteController::login'], null, ['GET' => 0, 'POST' => 1], null, false, false, null]],
        '/logout' => [[['_route' => 'app_logout', '_controller' => 'App\\Controller\\ConnecteController::logout'], null, null, null, false, false, null]],
        '/contact' => [
